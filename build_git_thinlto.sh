...
cmake ../${repoSrcStr}/llvm -G "Ninja" \
    ...
    -DLLVM_LIBDIR_SUFFIX="" \
   	...
   	-DCMAKE_EXE_LINKER_FLAGS="-Wl,-thinlto-jobs=4 -Wl,-thinlto-cache-policy,cache_size_bytes=4g -Wl,-thinlto-cache-dir='${stageBase}/objects/thinlto_cache'" || exit
...
echo -e "\e[95mstage 3 testing done, tests passed\e[39m"
	...
	#-DCMAKE_C_FLAGS="-O3 -D_GLIBCXX_DEBUG -g0     -Wl,-thinlto-jobs=4:-Wl,-thinlto-cache-policy,cache_size_bytes=4:-Wl,-thinlto-cache-dir='${stageBase}/build/thinlto_cache'" \

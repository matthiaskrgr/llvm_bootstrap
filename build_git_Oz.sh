...
cmake ../${repoSrcStr}/llvm -G "Ninja" \
	...
	-DCMAKE_C_FLAGS="-march=native -Oz -g0  -DNDEBUG" \
	-DCMAKE_CXX_FLAGS="-march=native -Oz -g0  -DNDEBUG" \
...
cmake ../${repoSrcStr}/llvm -G "Ninja" \
	-DCMAKE_BUILD_TYPE=MinSizeRel \
	-DLLVM_BINUTILS_INCDIR=/usr/include \
	-DCMAKE_C_FLAGS="-Oz -D_GLIBCXX_DEBUG -g0" \
	-DCMAKE_CXX_FLAGS="-Oz  -D_GLIBCXX_DEBUG -g0" \
